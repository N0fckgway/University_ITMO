...
set CLASSPATH=%APP_HOME%\lib\server-1.0-SNAPSHOT.jar;%APP_HOME%\lib\common-1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.10.1.jar;%APP_HOME%\lib\logback-classic-1.4.8.jar;%APP_HOME%\lib\javafaker-1.0.2.jar;%APP_HOME%\lib\logback-core-1.4.8.jar;%APP_HOME%\lib\slf4j-api-2.0.7.jar;%APP_HOME%\lib\commons-lang3-3.5.jar;%APP_HOME%\lib\snakeyaml-1.23-android.jar;%APP_HOME%\lib\generex-1.0.2.jar;%APP_HOME%\lib\automaton-1.11-8.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" ru.suvorov.server.Server %*
