...
public class City extends CollectionElement implements Validtable, Serializable, Comparable<City> {
    ...
    private ZonedDateTime creationDate; //Поле не может быть null, Значение этого поля генерируется автоматически
    ...
    public City(String name, Coordinates coordinates, Integer area, long population, double metersAboveSeaLevel, String capital, Climate climate, Government government, StandardOfLiving standardOfLiving, Human governor) {
