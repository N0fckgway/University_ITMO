...
import ru.suvorov.client.builder.ConcreteCityBuilder;
import ru.suvorov.client.builder.DirectorBuilder;
import ru.suvorov.server.File.json.DumpManager;
import ru.suvorov.utilities.model.City;
...
public class CollectionManager {
    ...
    public City getCollectionElement() {
